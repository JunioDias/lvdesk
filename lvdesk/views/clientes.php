...
<input class="btn btn-success btn_driver regular-link" value="Incluir" type="button" link="views/clientes-crud.php">
...
<thead>
  <tr class="filtro">
	...
	<th>Telefones <a><i class="mdi mdi-filter-variant icone-filtro"></i></a></th>
	<th>Ações</th>
  </tr>
...
$tabela  		= "clientes";					#tabela principal, alvo da rotina
$cbkedit		= "views/clientes-crud.php";	#callback do botão Editar
$cbkdel 		= "views/clientes.php";  		#callback do botão Excluir
