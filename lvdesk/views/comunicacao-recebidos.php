<div class="page-header-title">
  <h4 class="page-title">Caixa de Entrada</h4>
  <p>Lista de serviços atribuídos internamente a você</p>
</div>
<div class="content-sized">
	...
	$tabela  	= "comunicacao_interna_movimentos";		#tabela principal, alvo da rotina
	...
	WHERE c.lixo = 0 AND c.id_destinatario = '".$dadoslogin['id']."' ORDER BY data DESC";
