<div class="page-header-title">
  ...
  <p>Gerenciador dos grupos cadastrados no sistema</p>
</div>
<div class="content-sized">
<input class="btn btn-success btn_driver regular-link" value="Incluir" type="button" link="views/grupos-crud.php">
...
$query 			= "SELECT * FROM groups WHERE lixo = 0";

$nomediv		= ".content-sized";			#nome da div onde o callback vai ocorrer
$tabela  		= "groups";					#tabela principal, alvo da rotina
$cbkedit		= "views/grupos-crud.php";	#callback do botão Editar
$cbkdel 		= "views/grupos.php";  		#callback do botão Excluir
